...
Route::middleware(['auth', 'role:admin'])->prefix('admin')->group(function () {
    ...
    Route::get('/export/users', [\App\Http\Controllers\Admin\ExportToExcelController::class, 'exportUsersExcel']);

    Route::resource('keuzedelen', \App\Http\Controllers\Admin\KeuzedelController::class);
    Route::patch('/keuzedelen/{id}/toggle-active', [\App\Http\Controllers\Admin\KeuzedelController::class, 'toggleActive'])
        ->name('admin.keuzedelen.toggle-active');
    ...
    Route::patch('/periods/{id}/toggle-enrollment', [\App\Http\Controllers\Admin\PeriodController::class, 'toggleEnrollment'])
        ->name('periods.toggle-enrollment');
