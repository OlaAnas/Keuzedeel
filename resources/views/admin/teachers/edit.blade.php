...
<div style="max-width: 600px; margin: 0 auto; padding: 2rem;">
    <!-- Header -->
    <h1 style="margin: 0 0 2rem 0; font-size: 2rem; color: #333;">Docent Bewerken</h1>

    <!-- Form -->
    <form method="POST" action="{{ route('teachers.update', $teacher->id) }}" style="background: white; padding: 2rem; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
        @csrf
        @method('PUT')
